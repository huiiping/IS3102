...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $custMembershipTiersPromotion->cust_membership_tier_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $custMembershipTiersPromotion->cust_membership_tier_id)]
            )
        ?></li>
...
<div class="custMembershipTiersPromotions form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Cust Membership Tiers Promotion') ?></legend>
        <?php
        ?>
    </fieldset>
