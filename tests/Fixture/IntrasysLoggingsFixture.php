...
/**
 * IntrasysLoggingsFixture
 *
 */
class IntrasysLoggingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'intrasys_loggings_ibfk_1' => ['type' => 'foreign', 'columns' => ['retailer_id'], 'references' => ['retailers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
