...
class QuotationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rfq_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'filePath' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            ...
            'rfq_id' => ['type' => 'index', 'columns' => ['rfq_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'quotations_ibfk_1' => ['type' => 'foreign', 'columns' => ['supplier_id'], 'references' => ['suppliers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'quotations_ibfk_2' => ['type' => 'foreign', 'columns' => ['rfq_id'], 'references' => ['rfqs', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'modified' => '2017-03-18 01:54:07',
            'created' => '2017-03-18 01:54:07'
        ],
    ];
}
