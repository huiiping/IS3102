                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <?php if ($intrasysEmployee->activation_status == 'Activated'): ?>
                            <a class="btn btn-default btn-block" title="Deactivate Employee" href="/IS3102_Final/intrasys-employees/deactivateStatus/<?= $intrasysEmployee->id ?>" >Deactivate Employee</a>
                          <?php else: ?>
                            <a class="btn btn-default btn-block" title="Activate Employee" href="/IS3102_Final/intrasys-employees/activateStatus/<?= $intrasysEmployee->id ?>" >Activate Employee</a>
                          <?php endif; ?>
                        </td>
                        <td>
