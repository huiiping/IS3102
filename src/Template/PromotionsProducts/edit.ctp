...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $promotionsProduct->promotion_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $promotionsProduct->promotion_id)]
            )
        ?></li>
...
<div class="promotionsProducts form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Promotions Product') ?></legend>
        <?php
        ?>
    </fieldset>
