        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= __('Create New Product Type') ?></h3>
            </div>
            <div class="box-body">
                <?= $this->Form->create($prodType) ?>
                <fieldset>
                    <?php
                        echo $this->Form->input(('prod_name'), ['label' => 'Product Name']);
                        echo $this->Form->input(('prod_desc'), ['label' => 'Product Description']);
