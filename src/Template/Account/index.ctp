    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $account->userId]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $account->userId]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $account->userId], ['confirm' => __('Are you sure you want to delete # {0}?', $account->userId)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
