...
class IncidentreportsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'incidentreports_ibfk_1' => ['type' => 'foreign', 'columns' => ['employee_id'], 'references' => ['retaileremployees', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'dateCreated' => '2017-02-16 06:02:15',
            'status' => 1,
            'reference_id' => 1,
            'employee_id' => 1
        ],
