...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $customersPromotionemail->customer_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $customersPromotionemail->customer_id)]
            )
        ?></li>
...
<div class="customersPromotionemails form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Customers Promotionemail') ?></legend>
        <?php
        ?>
    </fieldset>
