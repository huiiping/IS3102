 ...
 *
 */
class RfqSuppliersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'rfq_suppliers_ibfk_1' => ['type' => 'foreign', 'columns' => ['rfq_id'], 'references' => ['rfqs', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'rfq_suppliers_ibfk_2' => ['type' => 'foreign', 'columns' => ['supplier_id'], 'references' => ['suppliers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
