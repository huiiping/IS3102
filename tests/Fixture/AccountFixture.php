...
class AccountFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'dateJoined' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'dateJoined' => '2017-02-07 05:13:09'
        ],
    ];
}
