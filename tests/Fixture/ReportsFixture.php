...
class ReportsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'delivery_order_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'delivery_order_id' => ['type' => 'index', 'columns' => ['delivery_order_id'], 'length' => []],
            'item_id' => ['type' => 'index', 'columns' => ['item_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'reports_ibfk_1' => ['type' => 'foreign', 'columns' => ['supplier_id'], 'references' => ['suppliers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'reports_ibfk_2' => ['type' => 'foreign', 'columns' => ['location_id'], 'references' => ['locations', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'reports_ibfk_3' => ['type' => 'foreign', 'columns' => ['delivery_order_id'], 'references' => ['delivery_orders', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'reports_ibfk_4' => ['type' => 'foreign', 'columns' => ['item_id'], 'references' => ['items', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'modified' => '2017-03-16 17:29:55',
            'created' => '2017-03-16 17:29:55'
        ],
    ];
}
