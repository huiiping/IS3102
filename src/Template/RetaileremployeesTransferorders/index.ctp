...
<div class="retaileremployeesTransferorders index large-9 medium-8 columns content">
    <h3><?= __('Retaileremployees Transferorders') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($retaileremployeesTransferorders as $retaileremployeesTransferorder): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $retaileremployeesTransferorder->retailerEmployee_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $retaileremployeesTransferorder->retailerEmployee_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $retaileremployeesTransferorder->retailerEmployee_id], ['confirm' => __('Are you sure you want to delete # {0}?', $retaileremployeesTransferorder->retailerEmployee_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
