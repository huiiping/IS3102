...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Retaileremployeerole'), ['action' => 'edit', $retaileremployeerole->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Retaileremployeerole'), ['action' => 'delete', $retaileremployeerole->id], ['confirm' => __('Are you sure you want to delete # {0}?', $retaileremployeerole->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Retaileremployeeroles'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Retaileremployeerole'), ['action' => 'add']) ?> </li>
...
<div class="retaileremployeeroles view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            ...
            <td><?= h($retaileremployeerole->roleName) ?></td>
        </tr>
        <tr>
    ...
    <div class="row">
        <h4><?= __('RoleDesc') ?></h4>
        <?= $this->Text->autoParagraph(h($retaileremployeerole->roleDesc)); ?>
    </div>
    <div class="related">
        <h4><?= __('Related Retaileremployees') ?></h4>
        <?php if (!empty($retaileremployeerole->retaileremployees)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($retaileremployeerole->retaileremployees as $retaileremployees): ?>
            <tr>
