          ...
          <form method="post" accept-charset="utf-8" action="/IS3102_Final/customers/edit/<?=$customer->id?>">
            ...
            <div class ="form-group">          
              <div class="input-group" title="Enter Member Identification*">
                ...
                <input class = "form-control" type="text" placeholder = "Member Identification*" name="member_identification" value = "<?=$customer->member_identification ?>" id="member_identification" maxlength="255"> 
              </div>
            </div>
            <div class ="form-group">            
        ...
        <div class ="form-group">            
          <div class="input-group" title="Enter Preferred Currency" style="z-index: 99999;">
            ...
            <select name="preferred_currency" id="preferred_currency" class='selectpicker form-control' title = "Preferred Currency*" data-live-search="true" required="required">
              ...
              <option selected="selected"><?php echo $customer->preferred_currency?></option>
        ...
        <div class ="form-group">            
          <div class="input-group" style="z-index: 0;" title="Select Mailing List">
            ...
            <label for="mailing-list">
              <?php if($customer->mailing_list == '1'):?>
              <input type="hidden" name="mailing_list" id="mailing-list" value="0">
              
              <input type="checkbox" name="mailing_list" id="mailing-list" value="1" checked>&nbsp;
              <?php else:?>
              <input type="checkbox" name="mailing_list" id="mailing-list" value="1">
              <?php endif;?>
             Mailing List</label>
           </div> 
         </div>
         ...
         <br>
         <div class ="row">
          <a href="/IS3102_Final/customers/index" class="btn btn-md btn-primary pull-left" style="border-radius: 8px; margin:5px;">Back to Customers Index</a>
          <button class="btn btn-md btn-success pull-right" type="submit" style="border-radius: 8px; margin:5px; ">Edit Customer</button>
        </div>
        <br>
      </form>
