...
class TransactionsController extends AppController
{
    ...
    public function view($id = null)
    {
        $transaction = $this->Transactions->get($id, [
            'contain' => ['Locations', 'Customers', 'Retaileremployees', 'Deliveryorders', 'Transactionitems']
        ]);
    ...
    public function add()
    {
        ...
        $this->set(compact('transaction', 'locations', 'customers', 'retaileremployees'));
        $this->set('_serialize', ['transaction']);
    }
