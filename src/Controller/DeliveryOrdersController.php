...
public function add2()
{
  ...
  $this->set('_serialize', ['deliveryOrder']);
    ...
    public function deliveredStatus($id) {
     ...
     var_dump($deliveryOrder->transaction_id);
     //changing all the items' status in the delivery order to sold
     ...
     foreach ($transactionItem as $itemID) {
       var_dump($itemID);
     ...
     $this->Flash->success(__('The delivery order has a delivered status. All items in that delivery order is sold.'));
