<?php
$this->assign('title', __('Intrasys Employees') . '/' . __('Manager Actions'));
...
$this->Html->addCrumb(__('Manager Actions : '.$intrasysEmployee->first_name.' '.$intrasysEmployee->last_name));
?>
