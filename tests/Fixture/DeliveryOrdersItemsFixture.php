...
/**
 * DeliveryOrdersItemsFixture
 *
 */
class DeliveryOrdersItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'delivery_orders_items_ibfk_1' => ['type' => 'foreign', 'columns' => ['delivery_order_id'], 'references' => ['delivery_orders', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'delivery_orders_items_ibfk_2' => ['type' => 'foreign', 'columns' => ['item_id'], 'references' => ['items', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
