...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $custmembershiptiersRetaileremployee->custMembershipTier_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $custmembershiptiersRetaileremployee->custMembershipTier_id)]
            )
        ?></li>
...
<div class="custmembershiptiersRetaileremployees form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Custmembershiptiers Retaileremployee') ?></legend>
        <?php
        ?>
    </fieldset>
