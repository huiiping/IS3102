...
class DeliveryorderitemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'deliveryOrder_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'deliveryOrder_id' => ['type' => 'index', 'columns' => ['deliveryOrder_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'deliveryorderitems_ibfk_1' => ['type' => 'foreign', 'columns' => ['deliveryOrder_id'], 'references' => ['deliveryorders', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
