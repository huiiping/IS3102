...
class TransferOrderItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'transfer_order_items_ibfk_1' => ['type' => 'foreign', 'columns' => ['transfer_order_id'], 'references' => ['transfer_orders', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'transfer_order_items_ibfk_2' => ['type' => 'foreign', 'columns' => ['item_id'], 'references' => ['items', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
