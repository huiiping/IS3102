    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('receiptID') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Number->format($transaction->receiptID) ?></td>
                ...
                <td><?= $transaction->has('retailer_employee') ? $this->Html->link($transaction->retailer_employee->last_name, ['controller' => 'RetailerEmployees', 'action' => 'view', $transaction->retailer_employee->id]) : '' ?></td>
